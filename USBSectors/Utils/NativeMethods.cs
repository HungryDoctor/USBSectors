...
namespace USBSectors.Utils
{
    internal static class NativeMethods
    {
        ...
        public static extern bool DeviceIoControl(
            ...
            [In] [MarshalAs(UnmanagedType.U4)] uint dwIoControlCode,
            [In, Optional] [MarshalAs(UnmanagedType.AsAny)] object lpInBuffer,
            [In] [MarshalAs(UnmanagedType.U4)] uint nInBufferSize,
            [Out, Optional] [MarshalAs(UnmanagedType.AsAny)] object lpOutBuffer,
